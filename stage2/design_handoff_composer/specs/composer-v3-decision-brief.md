...
### Decision A — How does Bindings live in the right panel?  ✅ **DECIDED: Option B**

> **Team decision:** Option B — hybrid. Inline editing in the right panel for simple widgets (Table, Crosstab, Selection List, Form widgets); full-screen takeover preserved for Chart and other complex types. See `composer-option-b.html` for the visual mockup of both flows.
